export default [
  {
    ...
    price: 180,
    horizontal: true,  // Указывает на горизонтальную ориентацию элемента
  },
  {
    title: 'Find the cheapest deals on our range...',
    image: 'https://source.unsplash.com/tb6ulgGY5Zc/840x840',
    price: 220,
    // Элемент без свойства 'horizontal' по умолчанию считается вертикальным
  },
  {
  ...
  },
  {
    ...
    price: 188,
    horizontal: true,  // Горизонтальная ориентация
  },
  {
